import "./PermissionListHeader.css"
...
const PermissionListHeader: React.FC<IProps> = ({ currentSort = "newest", onSortChange }) => {
    ...
    return (
        <div className="px-6 py-4 border-b border-surface-container flex items-center justify-between">
            <h3 className="text-lg font-bold text-primary">All Permissions</h3>
