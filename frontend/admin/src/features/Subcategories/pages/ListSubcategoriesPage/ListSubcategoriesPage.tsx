...
import type { ISubcategory, IPaginatedSubcategories } from "../../../../shared/types/Subcategories/ISubcategory.types";
import { GetAllSubcategories } from "../../services";
import {
  ListSubcategoryHeader,
  SubcategoryDashboardOverview,
  SubcategoryListHeader,
  ListSubcategoryCards,
  SubcategoryPaginationFooter,
  ListSubcategoryFooter
} from "../../components";
import "./ListSubcategoriesPage.css";
const ListSubcategoriesPage = () => {
  ...
  const fetchSubcategoriesData = useCallback(() => {
    GetAllSubcategories({ page, limit, sort })
      .then((res: IPaginatedSubcategories) => {
  ...
  }, [fetchSubcategoriesData, refreshTrigger]);
  const handleRefresh = () => {
    setLoading(true);
  ...
  return (
    <div className="p-8 space-y-8">
      <ListSubcategoryHeader />
      <SubcategoryDashboardOverview stats={overviewStats} Loading={Loading} />
      <div className="bg-surface-container-lowest rounded-xl shadow-sm overflow-hidden">
        <SubcategoryListHeader currentSort={sort} onSortChange={handleSortChange} />
        <div className="p-6">
          <ListSubcategoryCards
...
export default ListSubcategoriesPage;
