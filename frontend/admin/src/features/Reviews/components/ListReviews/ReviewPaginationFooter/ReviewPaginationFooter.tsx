...
import "./ReviewPaginationFooter.css"
interface ReviewPaginationFooterProps {
  currentPage: number;
  totalPages: number;
  totalItems: number;
  limit: number;
    ...
    <div className="px-6 py-4 bg-surface-container-low/20 flex flex-col md:flex-row items-center justify-between border-t border-surface-container gap-4">
      <div className="flex items-center gap-4">
        <p className="text-xs font-semibold text-on-surface-variant uppercase tracking-widest">
          {t.pagination.showing(totalItems === 0 ? 0 : startItem, endItem, totalItems)}
        </p>
        <div className="flex items-center gap-2">
          <label className="text-xs font-semibold text-on-surface-variant uppercase tracking-widest">{t.pagination.limit}</label>
          <select
...
export default ReviewPaginationFooter;
