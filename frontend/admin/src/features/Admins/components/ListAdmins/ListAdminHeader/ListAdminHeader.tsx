...
const CREATE_ADMIN_ROUTE = "/admins/create";

const ListAdminHeader = () => {
  const navigate = useNavigate();
  const t = useTranslation();

  const handleNavigateToCreateAdmin = () => {
    navigate(CREATE_ADMIN_ROUTE);
  };
  ...
  return (
    <div className="flex items-end justify-between">
      ...
      <button
        ...
        className="bg-gradient-to-br from-primary to-primary-container text-white px-6 py-3 rounded-xl font-bold flex items-center gap-2 shadow-lg shadow-primary/10 hover:shadow-primary/20 transition-all active:scale-95 duration-150"
      >
