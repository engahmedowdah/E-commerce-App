...
const UserDetailsSettings: React.FC = () => {
  return (
    <div className="bg-surface-container-lowest rounded-3xl p-12 border border-outline-variant/30 shadow-sm glass-panel flex flex-col justify-center items-center h-64 hover:shadow-md transition-shadow mb-12">
      ...
      <h3 className="text-2xl font-bold text-on-surface mb-3 tracking-tight">User Settings</h3>
      <p className="text-on-surface-variant text-center max-w-md">Configure advanced settings, URL handles, and metadata for this user.</p>
    </div>
  );
};
