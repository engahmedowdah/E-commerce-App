import "./PaymentStatusPaginationFooter.css"
interface PaymentStatusPaginationFooterProps {
  currentPage: number;
  totalPages: number;
  totalItems: number;
  limit: number;
...
const PaymentStatusPaginationFooter = ({
  currentPage,
  totalPages,
  totalItems,
  limit,
  onPageChange,
  onLimitChange
}: PaymentStatusPaginationFooterProps) => {
...
export default PaymentStatusPaginationFooter;
