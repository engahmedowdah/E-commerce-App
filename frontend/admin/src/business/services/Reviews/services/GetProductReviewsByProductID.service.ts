...
const GetProductReviewsByProductID: ({ ProductID, page, limit, sort }: { ProductID: string, page?: number, limit?: number, sort?: "newest" | "oldest" | "rating_asc" | "rating_desc" | "name_asc" | "name_desc" }) => Promise<IPaginatedReviews> = async ({ ProductID, page = 1, limit = 10, sort = "newest" }) => {
