import "./PaymentMethodPaginationFooter.css"
interface PaymentMethodPaginationFooterProps {
  currentPage: number;
  totalPages: number;
  totalItems: number;
  limit: number;
...
const PaymentMethodPaginationFooter = ({
  currentPage,
  totalPages,
  totalItems,
  limit,
  onPageChange,
  onLimitChange
}: PaymentMethodPaginationFooterProps) => {
...
export default PaymentMethodPaginationFooter;
