import "./PermissionPaginationFooter.css"
interface PermissionPaginationFooterProps {
  currentPage: number;
  totalPages: number;
  totalItems: number;
  limit: number;
...
const PermissionPaginationFooter = ({
  currentPage,
  totalPages,
  totalItems,
  limit,
  onPageChange,
  onLimitChange
}: PermissionPaginationFooterProps) => {
...
export default PermissionPaginationFooter;
