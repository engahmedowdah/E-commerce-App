...
type TSort = "newest" | "oldest" | "name_asc" | "name_desc" | "price_asc" | "price_desc";
interface IProps {
  currentSort?: TSort;
  onSortChange?: (sort: TSort) => void;
}
const ProductListHeader: React.FC<IProps> = ({ currentSort = "newest", onSortChange }) => {
    ...
    return (
        <div className="px-6 py-4 border-b border-surface-container flex items-center justify-between">
            <h3 className="text-lg font-bold text-primary">All Products</h3>
