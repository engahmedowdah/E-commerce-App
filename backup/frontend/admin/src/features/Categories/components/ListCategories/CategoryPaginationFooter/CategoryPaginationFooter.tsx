import "./CategoryPaginationFooter.css"
interface CategoryPaginationFooterProps {
  currentPage: number;
  totalPages: number;
  totalItems: number;
  limit: number;
...
const CategoryPaginationFooter = ({
  currentPage,
  totalPages,
  totalItems,
  limit,
...
export default CategoryPaginationFooter;
