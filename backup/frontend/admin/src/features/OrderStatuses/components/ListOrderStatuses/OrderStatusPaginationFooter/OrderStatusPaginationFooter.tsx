import "./OrderStatusPaginationFooter.css"
interface OrderStatusPaginationFooterProps {
  currentPage: number;
  totalPages: number;
  totalItems: number;
  limit: number;
...
const OrderStatusPaginationFooter = ({
  currentPage,
  totalPages,
  totalItems,
  limit,
  onPageChange,
  onLimitChange
}: OrderStatusPaginationFooterProps) => {
...
export default OrderStatusPaginationFooter;
