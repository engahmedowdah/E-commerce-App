import "./CountryPaginationFooter.css"
interface CountryPaginationFooterProps {
  currentPage: number;
  totalPages: number;
  totalItems: number;
  limit: number;
...
export default CountryPaginationFooter;
