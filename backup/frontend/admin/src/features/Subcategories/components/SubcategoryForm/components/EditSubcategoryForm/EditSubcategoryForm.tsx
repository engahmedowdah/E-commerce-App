...
const EditSubcategoryForm: React.FC<Props> = ({
  formData,
  initialData,
  products,
  loading,
  ...
  return (
    <>
      <form onSubmit={onSubmit} className="flex flex-col gap-8 w-full max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          <div className="md:col-span-8 flex flex-col gap-6">
            ...
            />
            <SubcategoryAssociatedProducts
              products={products ?? (initialData as ISubcategory)?.Products ?? []}
      ...
      <ConfirmModal
        ...
        message="This will unlink the product from this subcategory. The product itself will NOT be deleted from your inventory."
        confirmText="Unlink"
        cancelText="Cancel"
        type="warning"
      />
