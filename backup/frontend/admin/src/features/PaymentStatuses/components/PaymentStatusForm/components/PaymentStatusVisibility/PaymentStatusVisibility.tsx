...
const PaymentStatusVisibility: React.FC<Props> = ({ mode, isActivated, onChange }) => {
  ...
  return (
    <div className="bg-white p-6 rounded-[20px] shadow-sm border border-gray-100">
      <div className="flex justify-between items-center mb-5 mt-1">
        <h3 className="text-[16px] font-bold text-gray-900">PaymentStatus Status</h3>
...
export default PaymentStatusVisibility;
