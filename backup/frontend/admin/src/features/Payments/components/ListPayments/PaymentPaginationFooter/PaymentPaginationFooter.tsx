import "./PaymentPaginationFooter.css"
interface PaymentPaginationFooterProps {
  currentPage: number;
  totalPages: number;
  totalItems: number;
  limit: number;
...
export default PaymentPaginationFooter;
