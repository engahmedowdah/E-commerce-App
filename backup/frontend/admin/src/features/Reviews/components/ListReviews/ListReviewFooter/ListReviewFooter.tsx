  ...
  <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
    <div className="lg:col-span-3 bg-primary-container text-white p-8 rounded-xl relative overflow-hidden flex flex-col justify-center min-h-[200px]">
      <div className="relative z-10">
        <h4 className="text-2xl font-black tracking-tight mb-2">Boost product trust.</h4>
        <p className="max-w-md text-on-primary-container text-sm leading-relaxed mb-6 font-medium">Leverage authentic customer feedback to improve product quality and drive purchase confidence.</p>
    ...
    <div className="bg-tertiary-container text-tertiary-fixed-dim p-8 rounded-xl flex flex-col items-center justify-center text-center gap-4 border border-tertiary">
      <span className="material-symbols-outlined text-5xl">sentiment_very_satisfied</span>
      <div>
        <p className="text-lg font-bold text-white">Review Analytics</p>
        <p className="text-xs font-medium opacity-80 mt-1">Sentiment-driven curation</p>
      </div>
    </div>
  </div>
);
export default ListReviewFooter;
